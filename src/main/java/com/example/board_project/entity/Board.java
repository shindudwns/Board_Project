...
//    @Column(nullable = false)
    @ManyToOne(fetch = FetchType.EAGER) // 보통은 manytoone 이 주인이 된다
    ...
    @OneToMany(mappedBy = "board",fetch = FetchType.EAGER,cascade = CascadeType.REMOVE) // // 1:n 관계에서 1을 replylist 에 써줌
